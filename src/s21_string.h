...
// соответствия указанного имени в скобках существующему макросу
// если такой макрос не определен то возвращает 0;
#if defined(__linux__)
#define ERROR_NUM 134  // на линукс список из 134 ошибок
#define LIST_ERROR                                                             \
  {                                                                            \
...
#elif (__APPLE__)
#define ERROR_NUM 107  // количество ошибок на мак
#define LIST_ERROR                                                             \
  {                                                                            \
...
// Вспомогательная функция для strerror
// ALMETA TERRY
